...
% - Jika menggunakan Visual Studio Code sebagai editor, pastikan mengatur "latex-workshop.latex.tools" dan
...
\usepackage{tikz-uml} % for standard UML diagrams
\usepackage{needspace} % keep compact item headings with their following text
...
% Lingkungan algoritma tidak digunakan pada naskah ini, sehingga konfigurasi
% khusus algoritma dinonaktifkan untuk menghindari konflik paket float.
...
\cftsetrmarg{4em}  % mengikuti template, dengan ruang cukup untuk nomor halaman
...
\setlength{\cftsubsubsecindent}{7.7em}
...
\setcounter{tocdepth}{2} % daftar isi cukup sampai subbab agar tidak terlalu panjang
...
% --- Algoritma ---
% Konfigurasi caption khusus algoritma dinonaktifkan sementara karena
% lingkungan algoritma tidak digunakan pada draft saat ini.
...
% Mode kompak untuk naskah evaluasi digital: hindari halaman kosong verso yang
% berasal dari \cleardoublepage pada kelas book.
...
%\input{11 Daftar Algoritma.tex} % Dinonaktifkan karena tidak ada algoritma pada naskah saat ini.
%\input{12 Daftar Listing.tex} % Opsional; daftar listing dinonaktifkan agar naskah lebih ringkas.
...
\begin{appendices}
  ...
  %\makeatother
%\input{Lampiran-A.tex} % Opsional; contoh payload rinci tidak direferensikan dari bab utama.
