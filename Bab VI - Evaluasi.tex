...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.18\textwidth} >{\raggedright\arraybackslash}p{0.18\textwidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{0.18\textwidth}}
        ...
        Terpenuhi sebagai rancangan kesiapan integrasi \\
...
Keterbatasan tersebut tidak mengurangi nilai evaluasi terhadap kontribusi
arsitektural tugas akhir ini, tetapi menunjukkan ruang pengembangan untuk
pekerjaan lanjutan.
