...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[layerbox] (local) at (0,-4.35) {\textbf{Pemrosesan Lokal}\\Pengumpul Data dan Pemroses Lokal};
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \draw[line] (sensor.north) -- node[flowlabel, right] {video} (local.south);
    \draw[line] (local.north) -- node[flowlabel, right] {hasil inspeksi} (network.south);
    \draw[line] (network.north) -- node[flowlabel, right] {HTTP} (cloud.south);
