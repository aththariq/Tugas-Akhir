...
% ==========================================
\cleardoublepage
\chapter{ARSITEKTUR SISTEM INSPEKSI KONTAINER DIGITAL TERINTEGRASI}
\label{chap:perancangan}

Bab ini menyajikan artefak rancangan sistem inspeksi kontainer digital
terintegrasi. Susunan pembahasan dibuat mengikuti tujuan tugas akhir: deskripsi
umum sistem, rancangan arsitektur sistem, rancangan arsitektur data, model alur
informasi, dan pembagian fungsi antarkomponen.
...
Sistem inspeksi kontainer digital terintegrasi dirancang berdasarkan prinsip
...
konseptual antara sistem inspeksi kargo
...
Sistem inspeksi kontainer digital terintegrasi yang diusulkan mentransformasi
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.16\textwidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{0.14\textwidth}}
    ...
    \midrule
    Akuisisi Data & Perangkat terpisah, tidak terkoordinasi & Terintegrasi melalui komponen koordinasi dengan \textit{metadata} lengkap dan sinkronisasi multi-sumber & Efisiensi berpotensi meningkat \\
    Deteksi Kerusakan & Inspeksi visual manual, subjektif, inkonsisten & Deteksi berbasis analisis otomatis dengan tingkat keyakinan yang dapat divalidasi petugas & Konsistensi berpotensi meningkat \\
    Pemrosesan Data & Analisis manual oleh operator tunggal & Pemrosesan pada komponen lokal dan terpusat sesuai karakter beban & Responsivitas lebih terarah \\
    Pelaporan & Konsolidasi manual, format tidak standar, tertunda & Laporan digital terstruktur setelah data inspeksi diterima dan disimpan & Pelaporan lebih cepat \\
    ...
    Skalabilitas & Terbatas oleh jumlah petugas & Pemisahan komponen agar kapasitas dapat dikembangkan per lapisan & Skalabilitas lebih terencana \\
    Keandalan & Titik kegagalan tunggal, tanpa duplikasi & Pemisahan komponen lokal dan terpusat dengan pemantauan status layanan & Ketahanan lebih terstruktur \\
...
terpisah-pisah menuju sistem digital terintegrasi diarahkan untuk memperbaiki
alur pencatatan, konsistensi pembacaan hasil inspeksi, dan kesiapan
ketertelusuran terhadap standar. Dampak yang ditampilkan pada tabel merupakan
...
Bagian ini menjelaskan desain komponen sistem inspeksi kontainer digital, termasuk identifikasi komponen utama, tanggung jawab masing-masing komponen, dan pola interaksi antarkomponen. Desain ini kemudian menjadi dasar realisasi sistem pada proyek pengembangan sistem, sehingga pembahasannya menekankan struktur yang tercermin pada hubungan antara proses inspeksi, data, dan antarmuka pengguna.
...
arsitektur sasaran sistem inspeksi kontainer digital dalam ekosistem pelabuhan yang
...
Bagian ini menjawab tujuan ketiga tugas akhir, yaitu menyusun model alur
informasi yang memungkinkan integrasi hasil identifikasi, hasil pemindaian,
dan penyajian informasi kepada pengguna dalam satu sistem yang konsisten.
Arsitektur integrasi menjelaskan bagaimana sistem inspeksi kontainer digital
diposisikan terhadap sistem operasional eksternal yang sudah ada di ekosistem
pelabuhan. Integrasi dirancang dengan prinsip pemisahan tanggung jawab,
ketahanan terhadap kegagalan, dan kompatibilitas dengan sistem yang ada.
...
Keamanan sistem inspeksi kontainer digital dirancang dengan prinsip \textbf{pertahanan berlapis}, yaitu pemisahan beberapa area kontrol keamanan untuk melindungi data, sistem, dan akses pengguna. Desain keamanan diarahkan agar selaras dengan persyaratan regulasi dan praktik terbaik industri untuk pengelolaan informasi.
...
fungsi antarkomponen agar pemrosesan lokal, persistensi data, dan penyajian
informasi dapat berjalan sesuai kebutuhan operasional inspeksi kontainer.
...
\textbf{Penempatan lokal.} Komponen yang memerlukan responsivitas pada tahap pemantauan awal
...
Desain arsitektur sistem inspeksi kontainer digital secara eksplisit mempertimbangkan atribut kualitas yang didefinisikan dalam standar ISO/IEC 25010. Tabel~\ref{tbl:iso25010_mapping} memetakan komponen utama arsitektur terhadap atribut kualitas yang didukungnya.
...
ketertelusuran, pencatatan aktivitas pada lapisan sistem mendukung agar
...
Bab ini telah menyajikan desain arsitektur sistem inspeksi kontainer digital terintegrasi yang dirancang untuk mengatasi permasalahan yang telah diidentifikasi di Bab III. Desain ini berfokus pada integrasi komponen, pemrosesan responsif, dan konsistensi alur data sebagai dasar realisasi sistem yang diimplementasikan.
