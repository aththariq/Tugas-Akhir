...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.16\textwidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{0.14\textwidth}}
    ...
    Deteksi Kerusakan & Inspeksi visual manual, subjektif, inkonsisten & Deteksi berbasis analisis otomatis, objektif, konsisten dengan tingkat keyakinan & Konsistensi meningkat \\
    ...
    Notifikasi & Manual, tidak konsisten, tertunda & Multi-kanal berbasis aturan, otomatis, langsung kepada pengguna terotorisasi & Distribusi informasi lebih baik \\
...
terpisah-pisah menuju sistem digital terintegrasi diarahkan untuk meningkatkan
efisiensi operasional, konsistensi pembacaan hasil inspeksi, dan kesiapan
kepatuhan terhadap standar. Sistem usulan dirancang untuk mengatasi keterbatasan
...
Keamanan sistem inspeksi kargo digital dirancang dengan prinsip \textbf{pertahanan berlapis}, yaitu pemisahan beberapa area kontrol keamanan untuk melindungi data, sistem, dan akses pengguna. Desain keamanan konsisten dengan persyaratan regulasi dan praktik terbaik industri untuk pengelolaan informasi.
