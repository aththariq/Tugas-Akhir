...
\textit{backend} untuk orkestrasi proses bisnis serta persistensi data, komponen
...
Komponen layanan API direalisasikan sebagai layanan \textit{backend} berbasis
...
arsitektur yang implementatif, terintegrasi, dan mendukung kebutuhan
